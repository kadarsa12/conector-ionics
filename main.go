...
func main() {
	...
	clientId := flag.String("client_id", "AC6CB1CB6A594EAFA8D9009ED01C0233", "API Username Auth")
	clientSecret := flag.String("client_secret", "c4c574780cab4b22bf8e69629992bc69", "API Password Auth")
